...
describe("Heading Components", () => {
    ...
    it("should warn when H1 has no children", () => {
      ...
      expect(consoleErrorSpy).toHaveBeenCalledWith(
        expect.stringContaining(
          "The prop `children` is marked as required in `H1`",
        ),
      );
    });
  });
  ...
  describe("H2", () => {
    ...
    it("should warn when H2 has no children", () => {
      ...
      expect(consoleErrorSpy).toHaveBeenCalledWith(
        expect.stringContaining(
          "The prop `children` is marked as required in `H2`",
        ),
      );
    });
  });
  ...
  describe("H3", () => {
    ...
    it("should warn when H3 has no children", () => {
      ...
      expect(consoleErrorSpy).toHaveBeenCalledWith(
        expect.stringContaining(
          "The prop `children` is marked as required in `H3`",
        ),
      );
    });
  });
  ...
  describe("H4", () => {
    ...
    it("should warn when H4 has no children", () => {
      ...
      expect(consoleErrorSpy).toHaveBeenCalledWith(
        expect.stringContaining(
          "The prop `children` is marked as required in `H4`",
        ),
      );
    });
  });
  ...
  describe("H5", () => {
    ...
    it("should warn when H5 has no children", () => {
      ...
      expect(consoleErrorSpy).toHaveBeenCalledWith(
        expect.stringContaining(
          "The prop `children` is marked as required in `H5`",
        ),
      );
    });
  });
  ...
  describe("H6", () => {
    ...
    it("should warn when H6 has no children", () => {
      ...
      expect(consoleErrorSpy).toHaveBeenCalledWith(
        expect.stringContaining(
          "The prop `children` is marked as required in `H6`",
        ),
      );
    });
  });
