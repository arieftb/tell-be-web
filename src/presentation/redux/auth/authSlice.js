...
import RegAndLoginUseCase from "../../../application/auth/RegisterAndLoginUseCase.js";
...
import { GetCurrentUserUseCase } from "../../../application/user/GetCurrentUserUseCase.js";
...
export const registerAndLoginUser = createAsyncThunk(
  ...
  async (userData, { rejectWithValue }) => {
    try {
      const authRepository = new AuthRepository();
      const registerAndLoginUseCase = new RegAndLoginUseCase(authRepository);
